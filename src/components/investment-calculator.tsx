              ...
              <Select value={selectedCoin} onValueChange={setSelectedCoin}>
                ...
                <SelectContent className="bg-background border border-primary/30 max-h-60">
                  {stablecoins.map((coin) => (
                    <SelectItem key={coin.symbol} value={coin.symbol} className="text-gray-300 data-[highlighted]:text-gray-300 data-[highlighted]:bg-white/10">
                      <div className="flex items-center gap-2">
                        <Image
            ...
            <div>
              ...
              <Select value={returnPeriod} onValueChange={setReturnPeriod}>
                ...
                <SelectContent className="bg-background border border-primary/30">
                  <SelectItem value="weekly" className="text-gray-300 data-[highlighted]:text-gray-300 data-[highlighted]:bg-white/10">Weekly</SelectItem>
                  <SelectItem value="monthly" className="text-gray-300 data-[highlighted]:text-gray-300 data-[highlighted]:bg-white/10">Monthly</SelectItem>
                  <SelectItem value="yearly" className="text-gray-300 data-[highlighted]:text-gray-300 data-[highlighted]:bg-white/10">Yearly</SelectItem>
                </SelectContent>
              </Select>
            </div>
