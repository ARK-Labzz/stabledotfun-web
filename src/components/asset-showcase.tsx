...
export default function AssetShowcase({
  ...
  return (
    <div
      className={cn(
        "flex flex-col gap-1 bg-white/5 rounded-2xl p-3 lg:p-4 border border-secondary/30",
        className
      )}
    >
      ...
      <div className="relative flex flex-col lg:flex-row gap-3 overflow-hidden">
        ...
        <div className={cn(
          "lg:w-3/5 z-10",
          isMobile ? "w-full overflow-x-visible" : "flex"
        )}>
          ...
          {isMobile ? (
              ...
              <div className="flex gap-3 pb-2 w-max">
                {assets
                  ...
                  .map((coin, index) => (
                    <div
                      key={index}
                      className="w-[160px] rounded-lg p-3 border border-primary/50 bg-[#051016] flex-shrink-0"
                    >
                      <div className="flex justify-between items-start mb-2 gap-1">
                        ...
                        <div
                          className={cn(
                            "rounded-full p-0.5 bg-white/5 border-2",
                            coin.change > 0
                      ...
                      <div className="py-2">
                        ...
                        <div className="text-lg font-bold mb-2">{coin.yield}</div>
                      </div>
                      <div
                        className={`text-[10px] ${
            ...
            // For Desktop: Keep the existing stacked card effect with proper scrolling
            <div className="overflow-x-auto">
              <motion.div
                className={cn(
                  "relative h-[300px] bg-[#121c2200] flex gap-3",
                  isHover ? "w-max" : "w-[400px]" // Dynamic width based on hover
                )}
                    ...
                    <motion.div
                      ...
                      style={
                        !isHover
                          ? {
                              position: "absolute",
                              left: index * 50, // Reduced spacing for better visibility
                              height: 280 - 10 * index,
                              zIndex: 10 - index,
                            }
                          : undefined
                      ...
                      animate={{
                        ...
                        left: isHover ? undefined : index * 50,
        ...
        <div className="hidden lg:flex flex-1 z-0 rounded-2xl p-4 border border-secondary/30 bg-white/5 overflow-x-auto custom-scrollbar">
          <Table>
            <TableHeader>
