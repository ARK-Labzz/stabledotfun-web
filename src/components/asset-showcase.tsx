        ...
        <div className={cn(
          ...
          {isMobile ? (
            ...
            <motion.div
              className={cn(
            // We also have scrollbar here
                "relative h-full pb-6 md:pb-0 bg-[#121c2200] flex gap-3 flex-1 overflow-x-auto overflow-y-hidden custom-scrollbar min-h-[20rem]",
              ...
              {sortedData
                ...
                .map((el) => (
                  ...
                  >
                    ...
                    <TableCell className="text-center hidden md:table-cell">
                      {thursdayDates.startDate}
                    </TableCell>
                    <TableCell className="text-center hidden lg:table-cell">
                      {thursdayDates.maturityDate}
                    </TableCell>
                  </TableRow>
                ))}
            </TableBody>
