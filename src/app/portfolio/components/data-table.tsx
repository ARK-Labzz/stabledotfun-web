...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="relative flex flex-col gap-4">
      <div className="relative flex gap-3 flex-row justify-between mb-4">
      ...
      <div className="rounded-md border border-white/10 w-full overflow-x-auto custom-scrollbar">
      ...
      <div className="flex items-center justify-between space-x-2 py-4">
        {/* Page number indicators for mobile */}
...
//         </div>
//       </div>
//       <div className="rounded-md border border-white/10 w-[85vw] lg:w-auto overflow-x-auto">
//         <Table>
//           <TableHeader>
//             {table.getHeaderGroups().map((headerGroup) => (
//               <TableRow className="hover:bg-transparent" key={headerGroup.id}>
